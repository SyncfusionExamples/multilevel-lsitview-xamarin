...
This demo sample explains how to build a **multi-level (hierarchical) ListView** experience in Xamarin (e.g., expandable parent items with nested child items) using practical, production-ready techniques that work across **Android, iOS, and UWP**.

If you’re using Syncfusion controls in this sample, refer to the official overview:
